...
-- 4. feladat
SELECT `orszag` FROM `orszagok` WHERE `fovaros` LIKE "Intel" OR `fovaros` LIKE "Kingston" OR `fovaros` LIKE "Apple" OR `fovaros` LIKE "Fujitsu";
...
-- 11. feladat
SELECT `orszag`, `fovaros` FROM `orszagok` WHERE `foldr_hely` LIKE '%észak-amerikai%';

-- 12. feladat
SELECT `orszag`, `terulet` FROM `orszagok` ORDER BY `terulet` ASC LIMIT 1;

-- 13. feladat
SELECT `orszag`, `terulet` FROM `orszagok` WHERE `foldr_hely` LIKE '%európa%' ORDER BY `terulet` DESC LIMIT 1;

-- 14. feladat
SELECT `orszag`, `terulet` FROM `orszagok` WHERE `foldr_hely` LIKE '%közép-európai%' ORDER BY `terulet` ASC LIMIT 3;
...
-- 19. feladat
SELECT `orszag` FROM `orszagok` WHERE `valtopenz` LIKE '%cent%' AND `valtopenz` NOT LIKE '%eurocent%' ORDER BY `orszag` ASC;

-- 20. feladat
SELECT `orszag`, `foldr_hely` FROM `orszagok` WHERE `foldr_hely` LIKE '%európa%' ORDER BY `orszag` ASC;

-- 21. feladat
SELECT DISTINCT `penznem` FROM `orszagok` WHERE `penzjel` LIKE '%D' AND `penznem` NOT LIKE '%dollár%' ORDER BY `penznem` ASC;

-- 22. feladat
SELECT `orszag` FROM `orszagok` WHERE `allamforma` LIKE '%szövetség%';

-- 23. feladat
SELECT `penznem`, `orszag` FROM `orszagok` WHERE `valtopenz` NOT LIKE '%100%' ORDER BY `penznem` ASC;
